...
interface RemoteDependencyDataInterface { /**
...
export class RemoteDependencyData extends Domain { /**
	...
	constructor(options:RemoteDependencyDataInterface) {
		super()
		...
		this.data = DataSanitizer.sanitizeString(options.data)
		this.resultCode = DataSanitizer.sanitizeString(options.resultCode)
		this.target = DataSanitizer.sanitizeString(options.target)
		this.type = DataSanitizer.sanitizeString(options.type)
